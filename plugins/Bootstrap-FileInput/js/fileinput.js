...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            //noinspection HtmlUnknownAttribute
            tBtnBrowse = '<div tabindex="500" class="{css}" {status}>{icon} Dosya seç.</div>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    uploadRetryTitle: 'Yeniden Yükle',
                    downloadIcon: '<i class="glyphicon glyphicon-download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    downloadTitle: 'Dosyayı İndir',
                    zoomIcon: '<i class="glyphicon glyphicon-zoom-in"></i>',
                    zoomClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    zoomTitle: 'Detayını Göster',
                    ...
                    indicatorNewTitle: 'Henüz Yüklemediniz !',
                    indicatorSuccessTitle: 'Yüklendi',
                    indicatorErrorTitle: 'Yüklenemedi Hata !',
    ...
    $.fn.fileinputLocales.en = {
        ...
        removeLabel: 'Hepsini Sil',
        removeTitle: 'Sil',
        cancelLabel: 'İptal',
        cancelTitle: 'Abort ongoing upload',
        uploadLabel: 'Hepsini Yükle',
        uploadTitle: 'Dosyaları Yükle',
        msgNo: 'No',
        msgNoFilesSelected: '    Hiçbir dosya seçilmedi !',
        msgCancelled: 'Cancelled',
        msgPlaceholder: '    Dosya Seç...',
        msgZoomModalHeading: 'Detay Önizlemesi',
        msgFileRequired: 'You must select a file to upload.',
        msgSizeTooSmall: 'File "{name}" (<b>{size} KB</b>) is too small and must be larger than <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) exceeds maximum allowed upload size of <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'En az <b>{n}</b> dosya yüklemelisiniz !',
        ...
        msgInvalidFileName: 'Dosya uzantısı geçerli değil ! "{name}".',
        msgInvalidFileType: 'Invalid type for file "{name}". Only "{types}" files are supported.',
        msgInvalidFileExtension: 'Dosya için geçersiz uzantı "{name}". Bu uzantılı "{extensions}" dosyaları destekler.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadError: 'Hata Yüklenemedi !',
        msgValidationError: 'Validation Error',
        msgLoading: 'Loading file {index} of {files} &hellip;',
        msgProgress: 'Loading file {index} of {files} - {name} - {percent}% completed.',
        msgSelected: '    {n} Dosya Bulunuyor.',
        ...
        msgAjaxError: 'Dosya yükleme işleminde bir şeyler ters gitti. Lütfen daha sonra tekrar deneyiniz!',
        ...
        dropZoneTitle: 'Dosyaları buraya sürükleyip bırakabilirsiniz &hellip;',
        dropZoneClickTitle: '<br>(Tıkla Ve Seç {files})',
        previewZoomButtonTitles: {
            prev: 'Önceki dosyayı görüntüle',
            next: 'Sonraki dosyayı görüntüle',
            toggleheader: 'Başlık Gizle',
            fullscreen: 'Full Ekranda Aç',
            borderless: 'Kenarlıksız Modu Aç',
            close: 'Detay Önizlemesini Kapat'
        }
    };
